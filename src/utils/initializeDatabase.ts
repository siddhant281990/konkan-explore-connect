  ...
  try {
    ...
    const sampleBlogs = [
      ...
      },
      {
        ...
        status: 'published' as const,
        featured_image: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?w=800',
        gallery_images: [],
        views: 189
      },
      {
      ...
      },
      {
        ...
        status: 'published' as const,
        featured_image: 'https://images.unsplash.com/photo-1539650116574-75c0c6d73ab5?w=800',
        gallery_images: [],
        views: 167
      }
    ];
    ...
    const sampleHotels = [
      {
        ...
        featured_image: 'https://images.unsplash.com/photo-1571003123894-1f0594d2b5d9?w=800',
        gallery_images: []
      },
      {
        ...
        status: 'active' as const,
        featured_image: 'https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=800',
        gallery_images: []
      },
      {
      ...
      },
      {
        ...
        status: 'active' as const,
        featured_image: 'https://images.unsplash.com/photo-1590490360182-c33d57733427?w=800',
        gallery_images: []
      }
    ];
    ...
    if (!existingBlogs?.length) {
      ...
      if (blogError) {
        console.error('Error creating blogs:', blogError);
      } else {
    ...
    if (!existingHotels?.length) {
      ...
      if (hotelError) {
        console.error('Error creating hotels:', hotelError);
      } else {
